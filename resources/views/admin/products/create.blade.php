...
@section('content')
        <div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                ...
                <div>
                    <a href="{{ route('products.index') }}" class="btn btn-primary"><i class="far fa-question-circle me-1"></i> Kembali</a>
                </div>
            </div>
        </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="name" type="string" id="name" class="form-control" required>
                                    </div>

                                    <!-- Price -->
                                    <div class="mb-3">
                                        <label for="price" class="form-label">Price</label>
                                        <input name="price" type="integer" id="price" class="form-control" required>
                                    </div>
                                </div>
