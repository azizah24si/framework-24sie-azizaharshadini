                            ...
                            <div class="row mb-4">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="first_name" type="text" id="first_name" value="{{ $dataPelanggan->first_name }}" class="form-control"
                                            required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="last_name" type="text" id="last_name" value="{{ $dataPelanggan->last_name }}" class="form-control"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="birthday" type="date" id="birthday" value="{{ $dataPelanggan->birthday }}" class="form-control">
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="email" type="text" id="email" value="{{ $dataPelanggan->email }}" class="form-control"
                                            required>
                                    </div>
